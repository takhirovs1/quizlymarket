          ...
          Flexible(
            child: ListView(
              ...
              children: [
                ...
                Dimension.hBox16,
                BankCardWidget(
                  fullName: 'QuizlyMarket Card',
                  balance: context.user?.balance ?? .0,
                  id: context.user?.telegramID.toString() ?? '',
                  cardName: context.user?.name ?? '',
                ),
                Dimension.hBox16,
                Material(
                ...
                Material(
                  ...
                  clipBehavior: Clip.antiAlias,
                  child: CustomTile(
                    leading: Icon(CupertinoIcons.person_2, color: context.color.primary),
                    title: context.l10n.userList,
                    onTap: () {
                      context.telegramWebApp.hapticFeedback.impactOccurred(.light);
                      context.goNamed(Routes.adminUserList);
                    },
                  ),
                ),
                Dimension.hBox12,
                ...
                Material(
                  ...
                  clipBehavior: Clip.antiAlias,
                  child: CustomTile(
                    leading: Icon(Icons.width_full, color: context.color.primary),
