import 'package:flutter/cupertino.dart' hide showCupertinoDialog;
import 'package:flutter/material.dart';

import '../../../../../common/extension/context_extension.dart';
import '../../../../../common/model/language_option.dart';
import '../../../../../common/util/dimension.dart';
import '../../../../../common/widget/cupertino_back/cupertino_back_gesture.dart';
...
abstract class AdminProfileState extends State<AdminProfileScreen> {
  ...
  String formatVersion() {
    ...
    if (parts.length == 2) return '${parts[0]}(+${parts[1]}) Admin';
    return '$raw Admin';
  }
