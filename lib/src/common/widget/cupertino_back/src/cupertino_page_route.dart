...
final DecorationTween _kGradientShadowTween = DecorationTween(
  begin: _CupertinoEdgeShadowDecoration.none, // No decoration initially.
    ...
    edgeGradient: LinearGradient(
      ...
      colors: <Color>[Color(0x00000000), Color(0x00000000), Color(0x04000000), Color(0x12000000)],
...
mixin CupertinoRouteTransitionMixin<T> on PageRoute<T> {
  ...
  @override
  bool canTransitionTo(TransitionRoute<Object?> nextRoute) =>
  ...
  ///    would be allowed.
  static bool isPopGestureInProgress(PageRoute<Object?> route) => route.navigator!.userGestureInProgress;
  ...
  static _CupertinoBackGestureController<T> _startPopGesture<T>(PageRoute<T> route) {
    assert(_isPopGestureEnabled(route), 'Cannot start a pop gesture on route $route');
  ...
  Widget buildTransitions(
    ...
    Animation<double> secondaryAnimation,
    Widget child,
  ) => buildPageTransitions<T>(this, context, animation, secondaryAnimation, child);
}
...
class _CupertinoBackGestureDetector<T> extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(ObjectFlagProperty<ValueGetter<bool>>.has('enabledCallback', enabledCallback))
      ..add(
        ObjectFlagProperty<ValueGetter<_CupertinoBackGestureController<T>>>.has('onStartPopGesture', onStartPopGesture),
      );
  }
}
...
class _CupertinoBackGestureDetectorState<T> extends State<_CupertinoBackGestureDetector<T>> {
  ...
  void _handleDragEnd(DragEndDetails details) {
    assert(mounted, 'Tried to end a gesture on a disposed CupertinoRouteBackGestureDetector');
...
class _CupertinoEdgeShadowPainter extends BoxPainter {
  _CupertinoEdgeShadowPainter(this._decoration, VoidCallback? onChange) : super(onChange);
...
class _CupertinoModalPopupRoute<T> extends PopupRoute<T> {
  ...
  Animation<double> createAnimation() {
    assert(_animation == null, 'Cannot reuse _CupertinoModalPopupRoute animations.');
